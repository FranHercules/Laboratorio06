...
public class Consulta extends JFrame {
    ...
    public void llenarTabla(){
        ...
        for (Filtro fi: filtros){
            tm.addRow(new Object[]{fi.getCodigo(),fi.getMarca(),fi.getStock(),fi.getEsistencia()});
        }
        ...
        insertar.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(fd.delete(codigo.getText())){
                    ...
                    JOptionPane.showMessageDialog(null,"ocurrio un problema la momento de eliminar el filtro ");
                }
            ...
            public void actionPerformed(ActionEvent e){
                ...
                Filtro f = new Filtro(codigo.getText(),marca.getSelectedItem().toString(),Integer.parseInt(stock.getText()),true);
                if(f==null){
                    JOptionPane.showMessageDialog(null, "Filtro buscado no se encuentra");
                } else{
